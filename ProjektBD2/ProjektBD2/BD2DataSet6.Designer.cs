...
namespace ProjektBD2 {
    ...
    public partial class BD2DataSet6 : global::System.Data.DataSet {
        ...
        public partial class UserSetDataTable : global::System.Data.TypedTableBase<UserSetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserSetRow AddUserSetRow(string FirstName, string LastName, string JobTitle, string Email, int PhoneNumber, System.DateTime HireDate, UserSetRow parentUserSetRowByFK_UserUser, int AddressID, string Username) {
                ...
                if ((parentUserSetRowByFK_UserUser != null)) {
                    columnValuesArray[7] = parentUserSetRowByFK_UserUser[0];
                }
        ...
        public partial class UserSetRow : global::System.Data.DataRow {
            ...
            public int ManagerID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'ManagerID\' w tabeli \'UserSet\' to DBNull.", e);
                    }
                }
                set {
            ...
            public int AddressID {
                get {
                    return ((int)(this[this.tableUserSet.AddressIDColumn]));
                }
                set {
                    this[this.tableUserSet.AddressIDColumn] = value;
                }
            }
            ...
            public string Username {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'Username\' w tabeli \'UserSet\' to DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsUsernameNull() {
                return this.IsNull(this.tableUserSet.UsernameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetUsernameNull() {
                this[this.tableUserSet.UsernameColumn] = global::System.Convert.DBNull;
            }
...
namespace ProjektBD2.BD2DataSet6TableAdapters {
    ...
    public partial class UserSetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [UserSet] WHERE (([UserID] = @Original_UserID) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([HireDate] = @Original_HireDate) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)) AND ([AddressID] = @Original_AddressID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [UserSet] ([FirstName], [LastName], [JobTitle], [Email], [PhoneNumber], [HireDate], [ManagerID], [AddressID], [Username]) VALUES (@FirstName, @LastName, @JobTitle, @Email, @PhoneNumber, @HireDate, @ManagerID, @AddressID, @Username);
SELECT UserID, FirstName, LastName, JobTitle, Email, PhoneNumber, HireDate, ManagerID, AddressID, Username FROM UserSet WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [UserSet] SET [FirstName] = @FirstName, [LastName] = @LastName, [JobTitle] = @JobTitle, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [HireDate] = @HireDate, [ManagerID] = @ManagerID, [AddressID] = @AddressID, [Username] = @Username WHERE (([UserID] = @Original_UserID) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([HireDate] = @Original_HireDate) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)) AND ([AddressID] = @Original_AddressID));
SELECT UserID, FirstName, LastName, JobTitle, Email, PhoneNumber, HireDate, ManagerID, AddressID, Username FROM UserSet WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        UserID, FirstName, LastName, JobTitle, Email, PhoneNumber, HireDate" +
                ", ManagerID, AddressID, Username\r\nFROM            UserSet";
        ...
        public virtual int Delete(int Original_UserID, int Original_PhoneNumber, System.DateTime Original_HireDate, global::System.Nullable<int> Original_ManagerID, int Original_AddressID) {
        ...
        public virtual int Insert(string FirstName, string LastName, string JobTitle, string Email, int PhoneNumber, System.DateTime HireDate, global::System.Nullable<int> ManagerID, int AddressID, string Username) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string JobTitle, string Email, int PhoneNumber, System.DateTime HireDate, global::System.Nullable<int> ManagerID, int AddressID, string Username, int Original_UserID, int Original_PhoneNumber, System.DateTime Original_HireDate, global::System.Nullable<int> Original_ManagerID, int Original_AddressID, int UserID) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
            ...
            if ((Original_ManagerID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_ManagerID.Value));
            }
            else {
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string JobTitle, string Email, int PhoneNumber, System.DateTime HireDate, global::System.Nullable<int> ManagerID, int AddressID, string Username, int Original_UserID, int Original_PhoneNumber, System.DateTime Original_HireDate, global::System.Nullable<int> Original_ManagerID, int Original_AddressID) {
            return this.Update(FirstName, LastName, JobTitle, Email, PhoneNumber, HireDate, ManagerID, AddressID, Username, Original_UserID, Original_PhoneNumber, Original_HireDate, Original_ManagerID, Original_AddressID, Original_UserID);
        }
    }
